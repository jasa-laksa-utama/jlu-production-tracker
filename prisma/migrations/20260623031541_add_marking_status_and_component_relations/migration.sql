...
-- AlterTable
ALTER TABLE "project_components" ADD COLUMN     "markingStatus" TEXT NOT NULL DEFAULT 'PENDING',
ADD COLUMN     "packageId" UUID;

-- AlterTable
ALTER TABLE "projects" ADD COLUMN     "markingStatus" TEXT NOT NULL DEFAULT 'PENDING';

-- CreateIndex
CREATE UNIQUE INDEX "_UserRoles_AB_unique" ON "_UserRoles"("A", "B");

-- AddForeignKey
ALTER TABLE "project_components" ADD CONSTRAINT "project_components_packageId_fkey" FOREIGN KEY ("packageId") REFERENCES "shipment_packages"("id") ON DELETE SET NULL ON UPDATE CASCADE;
