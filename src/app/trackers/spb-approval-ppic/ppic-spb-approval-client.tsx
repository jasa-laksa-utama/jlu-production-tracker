...
import { approveSpbByPpic, rejectSpb } from "@/app/actions/spb";
...
export function PpicSpbApprovalClient({
  ...
  const [expandedBoqProjectId, setExpandedBoqProjectId] = useState<
    string | null
  >(null);
  ...
  return (
    <div className="space-y-4">
      ...
      >
        <TabsList className="grid w-[400px] grid-cols-2 bg-muted/65 p-1 rounded-2xl mb-6">
          ...
          >
            ...
            {spbs.length > 0 && (
              <span className="flex h-4.5 min-w-[18px] items-center justify-center rounded-full bg-blue-600 px-1 text-[10px] font-bold text-white shadow-xs">
                {spbs.length}
              </span>
            )}
          </TabsTrigger>
            ...
            <Card className="border border-dashed border-border/80 rounded-2xl p-12 text-center bg-card shadow-xs">
              <CardContent className="flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-xs text-muted-foreground max-w-sm mx-auto">
                  Semua dokumen Surat Permintaan Barang (SPB) telah diproses
                  atau tidak ada pengajuan baru dari divisi Engineering.
                </p>
              </CardContent>
            </Card>
          ) : (
                          ...
                          >
                            <div className="space-y-1.5">
                              ...
                              <div className="text-[11px] font-bold text-muted-foreground flex items-center gap-4">
                                ...
                                <span>
                                  Total Barang:{" "}
                                  <strong>{spb.items.length} Item</strong>
                                </span>
                              </div>
                            </div>
                            ...
                            <div className="flex items-center gap-3 shrink-0">
                              {spb.approvedByPm && (
                                <Badge className="bg-emerald-500/10 text-emerald-600 border-none shadow-none text-[9px] font-black rounded-lg">
                                  PM Approved
                                </Badge>
                              )}
                              <Button
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-between items-start sm:items-center bg-card border border-border/60 p-4 rounded-2xl shadow-xs">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold text-muted-foreground w-full sm:w-auto justify-end">
              ...
              <Button
                ...
                className="h-8 w-8 rounded-lg cursor-pointer"
                onClick={() =>
                  setCurrentPage((p) => Math.min(totalBoqPages, p + 1))
                }
          ...
          {paginatedBoqProjectGroups.length === 0 ? (
            <Card className="border border-dashed border-border/80 rounded-2xl p-12 text-center bg-card shadow-xs">
              <CardContent className="flex flex-col items-center justify-center gap-3">
                ...
                <p className="text-xs text-muted-foreground max-w-sm mx-auto">
                  Semua dokumen Bill of Quantities (BoQ) telah diproses atau
                  belum diajukan oleh Engineering.
                </p>
              </CardContent>
            </Card>
          ) : (
            <div className="grid grid-cols-1 gap-4">
              {paginatedBoqProjectGroups.map(
                ({ project, boqs: projectBoqs }, idx) => {
                    ...
                    >
                      ...
                      >
                        <div className="space-y-1">
                          <CardTitle className="text-base font-bold text-foreground">
                            {globalIndex}.{" "}
                            {project.projectName || "Tanpa Proyek"}
                          </CardTitle>
                          <CardDescription className="text-xs font-semibold text-muted-foreground">
                            No. Proyek: {project.projectNumber || "-"} |
                            Customer:{" "}
                            {project.customer?.company ||
                              project.customer?.name ||
                              "-"}
      ...
      {/* Detail Dialog showing SPB items & action buttons */}
      <Dialog
        open={!!selectedSpb}
      ...
      {/* Detail Dialog showing BoQ items & action buttons */}
      <Dialog
        open={!!selectedBoq}
            ...
            <div className="flex items-center justify-between w-full pr-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <DialogDescription className="text-xs text-muted-foreground font-medium mt-0.5">
                    Proyek: {selectedBoq?.project?.projectName} (
        ...
        <DialogContent className="sm:max-w-[420px] rounded-2xl border border-border shadow-2xl p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs text-muted-foreground mt-1">
              ...
              Tindakan ini akan tercatat dalam workflow persetujuan resmi dan
              menempelkan digital sign Anda pada dokumen SPB.
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter className="gap-2 mt-4">
            ...
            <Button
              ...
              className="cursor-pointer font-semibold bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg flex items-center gap-1.5"
            >
      ...
      {/* BoQ Approve Confirmation Dialog */}
      <Dialog
        open={!!approvingBoqId}
        ...
        <DialogContent className="sm:max-w-[420px] rounded-2xl border border-border shadow-2xl p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs text-muted-foreground mt-1">
              ...
              Tindakan ini akan tercatat dalam workflow persetujuan resmi dan
              menempelkan digital sign Anda pada dokumen BoQ.
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent className="sm:max-w-[420px] rounded-2xl border border-border shadow-2xl p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs text-muted-foreground mt-1">
              Masukkan alasan penolakan dokumen SPB ini. Alasan ini akan
              tercatat dalam log aktivitas sistem dan dapat dilihat oleh
              pengaju.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            ...
            <Input
              placeholder="Contoh: Stok material tidak memadai / BoQ salah..."
              value={rejectReason}
              onChange={(e) => setRejectReason(e.target.value)}
              className="rounded-xl border-border bg-background shadow-xs text-sm"
            />
          </div>
          ...
          <DialogFooter className="gap-2">
            ...
            <Button
              ...
              className="cursor-pointer font-semibold bg-red-600 hover:bg-red-700 text-white rounded-lg flex items-center gap-1.5"
            >
      ...
      >
        <DialogContent className="sm:max-w-[420px] rounded-2xl border border-border shadow-2xl p-6">
          <DialogHeader>
            ...
            <DialogDescription className="text-xs text-muted-foreground mt-1">
              Masukkan alasan penolakan dokumen BoQ ini. Alasan ini akan
              tercatat dalam log aktivitas sistem dan dapat dilihat oleh
              pengaju.
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="py-4">
            ...
            <Input
              placeholder="Contoh: Kode material salah / item tidak sesuai..."
              value={rejectReason}
              onChange={(e) => setRejectReason(e.target.value)}
              className="rounded-xl border-border bg-background shadow-xs text-sm"
            />
